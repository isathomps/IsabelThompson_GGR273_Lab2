...
map.getView().fit([-726613.902988, 5421122.625408, 798356.626414, 6699009.322198], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Lab2 Env Conservation</h2>';
        return titleElement;
    })(),
